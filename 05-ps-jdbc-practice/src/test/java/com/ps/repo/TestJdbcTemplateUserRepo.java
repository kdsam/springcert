...
public class TestJdbcTemplateUserRepo {
    ...
    public void testNoFindById() {
        //27: Use the JdbcTemplate instance to query for a user that does not exist and make this test pass
    ...
    public void testCount(){
        ...
        //28: Use the JdbcTemplate instance to query for the number of rows in the P_USER table
