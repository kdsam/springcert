 ...
 */
//21. Declare this class as an aspect
    @Aspect
    @Component
public class UserRepoMonitor {
    ...
    /*26. Declare this method as a Before advice and use as pointcut expression the expression
    ...
    /*22. Declare this method as a AfterReturning advice and create a pointcut expression that matches any method
     with the name starting with "update" that is defined in a class with the name containing "Service" */
    @AfterReturning(value = "execution (* com.ps.repos.*.*UserRepo+.updatePassword(..))", returning = "result")
    ...
    /*23. Declare this method as a AfterThrowing advice and create a pointcut expression that matches any method
     named updateUsername that is defined in a class with the name containing "Service" */
    @AfterThrowing(value = "execution(* com.ps.repos.*.*UserRepo+.updateUsername(..))", throwing = "e")
    ...
    /*24. Declare this method as an Around advice and create a pointcut expression that matches any method
    ...
    public Object monitorFind(ProceedingJoinPoint joinPoint) throws Throwable {
        ...
        try {
            return joinPoint.proceed(); //25. Call the target method
